...
MNIST_DS::MNIST_DS(bool flag)
    : train{flag}, n{0}, m{0}, magic_number{0}, number_of_items{0},
      image_dat_set{nullptr}, label_dat_set{nullptr}, mini_batch_size{0},
      mini_batch_images{nullptr}, mini_batch_labels{nullptr} {
...
// Get image
Matrix MNIST_DS::getImage(int index) { return image_dat_set[index]; }
...
Matrix *MNIST_DS::getMiniBatchImages() { return mini_batch_images; }

unsigned char *MNIST_DS::getMiniBatchLabels() { return mini_batch_labels; }